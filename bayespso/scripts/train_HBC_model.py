...
PATH_TO_DATA = '/home/user/ml-hbc/HBC_tools/data/atlas-higgs-challenge-2014-v2.csv'
NR_TRAIN = 250000
NR_TEST = 550000
HYPERPARAMETERS = {
    "num_boost_round": 500,
    ...
    "learning_rate": 0.20565096334412214,
    "max_depth": 7,
...
def main():
    ...
    with open('timing.txt', 'wt') as outFile:
        outFile.write('Duration: %ss' %(end-start))
